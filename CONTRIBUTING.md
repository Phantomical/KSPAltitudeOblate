...
Next, you will want to create a `AltitudeOblate.props.user` file
...
This will create a `GameData\AltitudeOblate` folder which you can then drop
...
> ```batch
> mklink /j AltitudeOblate C:\path\to\AltitudeOblate\repo\GameData\AltitudeOblate
> ```
>
