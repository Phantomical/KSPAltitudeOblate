...
Next, you will want to create a `OblateAtmosphere.props.user` file
...
This will create a `GameData\OblateAtmosphere` folder which you can then drop
...
> ```batch
> mklink /j OblateAtmosphere C:\path\to\OblateAtmosphere\repo\GameData\OblateAtmosphere
> ```
>
